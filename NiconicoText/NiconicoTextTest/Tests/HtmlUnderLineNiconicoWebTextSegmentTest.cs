...
namespace NiconicoTextTest.Tests
{
    ...
    public class HtmlUnderLineNiconicoWebTextSegmentTest
    {
        ...
        {
            var segmentes = new NiconicoWebTextSegmentCollection();
            segmentes.Add(new PlainNiconicoWebTextSegment("testText"));
            ...
            Assert.AreEqual(segmentes, segment.Segments);
        ...
        public void ParseWebTextTest(string text)
        {
            ...
            INiconicoWebTextSegment segment = HtmlUnderLineNiconicoWebTextSegment.ParseWebText(match, segmenter);
            Assert.AreEqual(NiconicoWebTextSegmentType.HtmlUnderLineElement, segment.SegmentType);
        }
